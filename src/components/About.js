...
export default function About() {
    ...
    useEffect(()=>{
            ...
            init(myElement, {
                    ...
                    strings: ["I am actually following a web development bootcamp @ Becode Brussels and looking for an internship as a junior Front-end developer in a creative company to the skills acquired during this training."]
                });
